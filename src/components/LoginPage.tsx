...
import { FileText, Mail, Lock, Eye, EyeOff, ArrowRight, TrendingUp, CheckCircle2 } from 'lucide-react';
import { useApp } from '@/context/AppContext';

export function LoginPage() {
  const { login } = useApp();
  const [email, setEmail] = useState('demo@mybusiness.co.za');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!ok) { setError('Invalid credentials. Please try again.'); setLoading(false); }
  };
    ...
    <div className="min-h-screen flex bg-[#faf8f5]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#f5f0ea]">
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle at 1px 1px, #1e1b2e 1px, transparent 0)',
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-20 max-w-2xl">
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="font-bold text-[#2a2438] text-xl tracking-tight">InvoiceFlow</span>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12 relative">
        ...
        <div className="relative z-10 w-full max-w-md animate-fade-in-up">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-[#3d3551]/8 border border-[#f0ebe5] p-7 sm:p-9">
            {/* Desktop brand mark inside card */}
            <div className="hidden lg:flex items-center gap-2.5 mb-7">
              ...
              <span className="font-bold text-[#2a2438] text-sm">InvoiceFlow</span>
            </div>

            <h2 className="text-2xl font-bold text-[#2a2438] mb-1.5 tracking-tight">Welcome back</h2>
            <p className="text-[#8a8295] text-sm mb-7">Sign in to manage your invoices.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 border rounded-xl text-sm transition-all duration-200 outline-none ${
                      focused === 'email'
                        ? 'border-[#6b5d8a] ring-2 ring-[#6b5d8a]/15 bg-white'
                        : 'border-[#e8e3dd] bg-[#faf8f5] hover:border-[#d4cce0]'
                    }`}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={() => setFocused(null)}
                    placeholder="••••••••"
                    className={`w-full pl-10 pr-10 py-3 border rounded-xl text-sm transition-all duration-200 outline-none ${
                      focused === 'password'
                        ? 'border-[#6b5d8a] ring-2 ring-[#6b5d8a]/15 bg-white'
                        : 'border-[#e8e3dd] bg-[#faf8f5] hover:border-[#d4cce0]'
                    }`}
                  ...
                  <button
                    ...
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#c4bedb] hover:text-[#6b5d8a] transition-colors"
                  >
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button type="button" className="text-sm text-[#6b5d8a] hover:text-[#3d3551] font-medium transition-colors">
                  Forgot password?
                </button>
              </div>
            ...
            <div className="mt-7 pt-6 border-t border-[#f0ebe5] text-center">
              <p className="text-sm text-[#8a8295]">
                ...
                <button className="text-[#6b5d8a] hover:text-[#3d3551] font-semibold transition-colors">
                  Create account
                </button>
              </p>
            </div>
          ...
          <p className="text-center text-xs text-[#b8b0c4] mt-5">
